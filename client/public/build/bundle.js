...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 59, 0, 1029);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file, 98, 12, 2323);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 106, 8, 2578);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 109, 8, 2698);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 127, 8, 3262);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			current = true;
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 130, 8, 3372);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 133, 8, 3482);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot(ctx) {
    	...
    	let if_block4 = /*login_hint*/ ctx[9] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file, 95, 8, 2214);
    			...
    			add_location(select, file, 96, 8, 2236);
    			attr_dev(div0, "class", "address svelte-1q92huv");
    			add_location(div0, file, 94, 6, 2183);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "svelte-1q92huv");
    			add_location(input0, file, 114, 10, 2856);
    			add_location(label0, file, 113, 8, 2829);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "class", "svelte-1q92huv");
    			add_location(input1, file, 117, 10, 2952);
    			add_location(label1, file, 116, 8, 2925);
    			attr_dev(input2, "type", "submit");
    			input2.value = "Login";
    			attr_dev(input2, "class", "svelte-1q92huv");
    			add_location(input2, file, 119, 8, 3025);
    			attr_dev(div1, "class", "login-loader svelte-1q92huv");
    			add_location(div1, file, 121, 8, 3113);
    			attr_dev(form, "class", "svelte-1q92huv");
    			add_location(form, file, 112, 6, 2788);
    			attr_dev(div2, "class", "wrapper svelte-1q92huv");
    			add_location(div2, file, 92, 4, 2152);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 90, 0, 2131);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},

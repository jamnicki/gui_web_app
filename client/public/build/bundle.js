...
var app = (function () {
    ...
    function create_default_slot(ctx) {
    	...
    	let if_block1 = /*addresses_hint*/ ctx[6] && create_if_block_3(ctx);
    	...
    	let if_block2 = /*connected*/ ctx[4] && create_if_block_2(ctx);
    	let if_block3 = /*login_error*/ ctx[8] && create_if_block_1(ctx);
    ...
    // (1:0) <script>   import Login from './Panels/Login.svelte';     async function checkConnection() {    let res = await fetch('/check-connection');    let json = await res.json()    return json.connected;   }
    function create_catch_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "catch",
    		source: "(1:0) <script>   import Login from './Panels/Login.svelte';     async function checkConnection() {    let res = await fetch('/check-connection');    let json = await res.json()    return json.connected;   }",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "fail svelte-17inoh8");
    			add_location(span, file, 21, 3, 516);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "success svelte-17inoh8");
    			add_location(span, file, 19, 3, 451);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    // (16:19)     <span class="success">Sprawdzam...</span>   {:then value}
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "success svelte-17inoh8");
    			add_location(span, file, 16, 2, 373);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(16:19)     <span class=\\\"success\\\">Sprawdzam...</span>   {:then value}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	handle_promise(/*connected*/ ctx[0], info);
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			info.block.c();
    			add_location(button, file, 14, 1, 297);
    			attr_dev(div, "class", "check-connection svelte-17inoh8");
    			add_location(div, file, 13, 0, 264);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", checkConnection, false, false, false);
    				mounted = true;
    			}
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Login, checkConnection, connected });

...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$3, 60, 0, 957);
    		},
    ...
    const file$2 = "src/Panels/Login.svelte";
    ...
    function create_if_block_8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 106, 8, 2898);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_7$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(select, file$2, 100, 8, 2682);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option, file$2, 102, 12, 2774);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_6$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$2, 124, 10, 3392);
    			attr_dev(div, "class", "addresses-action svelte-1brpval");
    			add_location(div, file$2, 118, 8, 3252);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_5$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$2, 115, 10, 3146);
    			attr_dev(div, "class", "addresses-action svelte-1brpval");
    			add_location(div, file$2, 109, 8, 3007);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    ...
    function create_if_block_4$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 133, 6, 3630);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    ...
    function create_if_block_3$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 136, 6, 3741);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    ...
    function create_if_block_2$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 155, 6, 4273);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			current = true;
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 158, 6, 4374);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 161, 6, 4475);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$2, 98, 6, 2622);
    			if (img.src !== (img_src_value = "icon/refresh.svg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "select");
    			add_location(img, file$2, 128, 8, 3529);
    			attr_dev(div0, "class", "addresses-action svelte-1brpval");
    			add_location(div0, file$2, 127, 6, 3466);
    			attr_dev(div1, "class", "address svelte-1brpval");
    			add_location(div1, file$2, 92, 4, 2470);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "svelte-1brpval");
    			add_location(input0, file$2, 142, 8, 3895);
    			add_location(label0, file$2, 140, 6, 3862);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "class", "svelte-1brpval");
    			add_location(input1, file$2, 146, 8, 3993);
    			add_location(label1, file$2, 144, 6, 3960);
    			attr_dev(input2, "type", "submit");
    			input2.value = "Login";
    			attr_dev(input2, "class", "svelte-1brpval");
    			add_location(input2, file$2, 148, 6, 4062);
    			attr_dev(div2, "class", "login-loader svelte-1brpval");
    			add_location(div2, file$2, 149, 6, 4138);
    			attr_dev(form, "class", "svelte-1brpval");
    			add_location(form, file$2, 139, 4, 3824);
    			attr_dev(div3, "class", "login svelte-1brpval");
    			add_location(div3, file$2, 91, 2, 2446);
    			attr_dev(div4, "class", "wrapper svelte-1brpval");
    			add_location(div4, file$2, 90, 0, 2390);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_5$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(91:6) {#if any_test_running}",
    		ctx
    	});
    ...
    function create_if_block_4$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "message error svelte-1tm4rqk");
    			add_location(span, file$1, 98, 4, 2574);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    ...
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "message error svelte-1tm4rqk");
    			add_location(span, file$1, 131, 14, 3573);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			current = true;
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "message success svelte-1tm4rqk");
    			add_location(span, file$1, 129, 14, 3457);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			current = true;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(129:12) {#if test.passed == 1}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(span, "class", "message error svelte-1tm4rqk");
    			add_location(span, file$1, 134, 14, 3694);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    ...
    // (102:4) {#each tests as test, i (test.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			if (if_block2) if_block2.c();
    			t10 = space();
    			attr_dev(span, "class", "svelte-1tm4rqk");
    			add_location(span, file$1, 109, 12, 2911);
    			attr_dev(button, "class", "svelte-1tm4rqk");
    			add_location(button, file$1, 113, 12, 3007);
    			attr_dev(div0, "class", "test-bar svelte-1tm4rqk");
    			add_location(div0, file$1, 108, 10, 2876);
    			attr_dev(p0, "class", "test-name svelte-1tm4rqk");
    			add_location(p0, file$1, 126, 12, 3328);
    			add_location(p1, file$1, 127, 12, 3382);
    			attr_dev(div1, "class", "test-content svelte-1tm4rqk");
    			add_location(div1, file$1, 125, 10, 3289);
    			attr_dev(div2, "class", "test-wrapper svelte-1tm4rqk");
    			add_location(div2, file$1, 107, 8, 2839);
    			attr_dev(div3, "class", "test big svelte-1tm4rqk");
    			toggle_class(div3, "big", /*test*/ ctx[8].passed == 0);
    			add_location(div3, file$1, 102, 6, 2715);
    			this.first = div3;
    		},
    		m: function mount(target, anchor) {
    		...
    		a: function animate() {
    			stop_animation();
    			stop_animation = create_animation(div3, rect, flip, { duration: 400 });
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(102:4) {#each tests as test, i (test.id)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	validate_each_argument(each_value);
    	const get_key = ctx => /*test*/ ctx[8].id;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1tm4rqk");
    			add_location(h1, file$1, 87, 2, 2290);
    			add_location(button, file$1, 89, 4, 2369);
    			attr_dev(div0, "class", "controls svelte-1tm4rqk");
    			add_location(div0, file$1, 88, 2, 2342);
    			attr_dev(div1, "class", "tests svelte-1tm4rqk");
    			add_location(div1, file$1, 100, 2, 2650);
    			attr_dev(div2, "class", "wrapper svelte-1tm4rqk");
    			add_location(div2, file$1, 86, 0, 2234);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    	...
    	async function testRun(i) {
    		...
    		try {
    			...
    			if (json.passed == 0 && test.passed != 0) {
    				...
    				tests.unshift(test);
    			} else // find a proper place for a resolved test
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file, 40, 6, 1003);
    			attr_dev(span1, "class", "button svelte-xp5i5m");
    			add_location(span1, file, 41, 6, 1040);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file, 49, 6, 1200);
    			attr_dev(span1, "class", "button svelte-xp5i5m");
    			add_location(span1, file, 50, 6, 1237);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span0, anchor);
    			insert_dev(target, t3, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 81, 4, 1811);
    			add_location(button1, file, 82, 4, 1865);
    			add_location(button2, file, 83, 4, 1913);
    			attr_dev(div, "class", "check-connection svelte-xp5i5m");
    			add_location(div, file, 71, 2, 1554);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 78, 8, 1738);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 76, 8, 1670);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 60, 0, 1381);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},

...
var app = (function () {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 87, 4, 2411);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 93, 6, 2631);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1lpkeaz");
    			add_location(img, file$1, 91, 6, 2541);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 77, 2, 2058);
    			attr_dev(button0, "class", "single svelte-1lpkeaz");
    			add_location(button0, file$1, 79, 4, 2105);
    			add_location(br, file$1, 80, 4, 2187);
    			attr_dev(button1, "class", "success");
    			add_location(button1, file$1, 81, 4, 2199);
    			attr_dev(button2, "class", "error");
    			add_location(button2, file$1, 84, 4, 2302);
    			attr_dev(div0, "class", "buttons svelte-1lpkeaz");
    			add_location(div0, file$1, 78, 2, 2078);
    			attr_dev(div1, "class", "video svelte-1lpkeaz");
    			add_location(div1, file$1, 89, 2, 2489);
    			attr_dev(div2, "class", "wrapper svelte-1lpkeaz");
    			add_location(div2, file$1, 76, 0, 1982);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	socket.on("frame", data => {
    		$$invalidate(0, video_visible = true);
    		$$invalidate(1, video_frame = data.frame);
    	});
